...
import { Box, Grid, VStack, Text, Heading, Icon } from "@chakra-ui/react";
...
const Groups: React.FC = () => {
	...
	return (
		<Box bg={pageBgColor} minH="calc(100vh - 40px)" px={6} pt={4}>
			<Grid templateColumns="400px 1fr" gap={6} maxW="1400px" mx="auto">
				{/* Left Sidebar */}
				<Box
					borderRight="1px"
